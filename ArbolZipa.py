...
class ArbolZipa():
    ...
    def crear_arbol(self):
        ...
        h2o.remove_all() 
        df = pd.read_excel('C:/Users/yulea/Documents/pruebasPY/p18.xlsx',encoding="ISO-8859-1")
    ...
    def predecir(self):
        ...
        final_rf_predictions = self.rf_v2.predict(self.test[:-1])
